  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (page === 'services') {
        ...
        if (metaKeywords) {
          metaKeywords.setAttribute('content', 'Sharkings, Sharkings Interiors, Sharkings Interior, Sharkings Interior Design, Sharkings Madurai, Sharkings Ramanathapuram, Sharkings Ramnad, best interior designer in Madurai, best interior designer in Ramanathapuram, modular kitchen Madurai, home interior design Ramanathapuram, turnkey interiors Tamil Nadu, Home interior designer in madurai, Modular kitchen interior designer, Professional interior designers, Best interior designer, Best ineterior designer in villa puram in madurai, Best interior decorators in villapuram, Home interior designers in madurai, Madurai interior designer, Interior designer in salem, Interior designer works, Interior and exterior works in madurai, kitchen interior designer, Modular kitchen interior, Interior desingner in sivakangai, Interior desingner in dindigul, Interior desingner in virudhunager, Interior desingner in theni, Interior desiner cost in madurai, Interior designer price in madurai, Interior desginer near me madurai');
        }
      }
    };
